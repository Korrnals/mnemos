...
**По модели «ornith» (вопрос владельца):** существует — `ornith-ai/Ornith-1.5` (9B/35B/397B, MIT, линейж поверх Qwen3.5+Gemma4), но это **чат/резонинг LLM**, не эмбеддер и не нано-класс — не подходит ни учителем, ни рефайнером. Возможно, встречалась в трендах HF.
