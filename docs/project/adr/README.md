...
| [0029](0029-search-v2-query-semantics.md) | Search v2 query semantics: per-token prefix AND, soft project fallback, graph leg, embedding_id stamp | Proposed (issue #313; independent review pending) | 2026-09-15 |
