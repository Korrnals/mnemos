...
<!-- version:pip -->
```bash
pip install https://github.com/Korrnals/mnemos/releases/download/v2.7.3/mnemos-2.7.3-py3-none-any.whl
```
<!-- /version:pip -->
...
<!-- version:tags -->
Теги: `:2.7.3` (фиксированная) · `:latest` (rolling). Работает и с `docker` — замените `podman` на `docker`.
<!-- /version:tags -->
